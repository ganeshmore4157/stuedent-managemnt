...
public class JwtTokenHelper {
    ...
    private long getNextSixAM() {
        ...
        LocalDateTime tomorrowAt6AM = tomorrow.atTime(6, 0);

        // Convert to milliseconds (Epoch time)
        ZonedDateTime zonedDateTime = tomorrowAt6AM.atZone(ZoneId.systemDefault());
